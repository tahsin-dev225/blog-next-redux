        ...
        <div className="h-screen w-full ">
            ...
            <div className="w-[40%] mx-auto my-8 rounded bg-red-200/10 border border-slate-600 p-6">
                <form onSubmit={handleSignUp} className="">
                    ...
                    <input type="text" placeholder="Name" name="name" className="py-2 px-3 w-full my-4 rounded bg-slate-100 text-slate-900" />
                    ...
                    <input type="submit" className="py-2 w-full rounded bg-blue-900/90 text-white my-7" value="Sign-up" />
