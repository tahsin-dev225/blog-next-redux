...
const page = () => {
    const {user, createUser,googleSignIn } = useFirebase();
    ...
    const googleSignUp = ()=>{
        googleSignIn()
        .then(res =>{
            console.log('from 123455',res?.user?.email)
            const newUser = {
    ...
    return (
        <div className="h-screen w-full ">
            ...
            <div className="w-[35%] mx-auto my-8 rounded bg-red-200/10 border border-slate-600 p-6">
                ...
                <div className="w-full my-4 flex justify-center items-center">
                    <button onClick={()=>googleSignUp()} className="btn "><FcGoogle className="text-2xl" /> Sign-up with Google.</button>
                </div>
